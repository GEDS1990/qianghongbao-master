 ...
 * <p><a href="http://www.codeboy.com">LeonLee Blog</a></p>
 *
 * @author LeonLee
 */
...
//    private Notification nf;
    ...
    public void onReceiveJob(AccessibilityEvent event) {
        ...
        if(eventType == AccessibilityEvent.TYPE_NOTIFICATION_STATE_CHANGED) {
            ...
            isReceivingHongbao = true;//geds add
    ...
    /** 显示debug信息对话框*/
    private void showDebugDialog01(Object... args){
        String text = "";
        for(Object i:args ) {
    ...
    private void notificationEvent(String ticker, Notification nf) {
        /** 是否可以取出红包的数量、剩余金额的数据？修改剩余数量从而使产生的红包金额变大？**/
//        NotificationManager nm = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
//        new AlertDialog.Builder(self)
//                .setTitle("通知栏事件")
//                .setMessage("ticker："+ticker+";Notification:"+nf)
//                .setPositiveButton("确定", null)
//                .show();
        Toast.makeText(getContext(), "已保存到:", Toast.LENGTH_LONG).show();

//        showDebugDialog01(ticker,nf.tickerText);
        String text = ticker;
    ...
    private void handleLuckyMoneyReceive() {
        ...
        int wechatVersion = getWechatVersion();//1321
